...
Read two real numbers, print the sum of the squares of them.
...
object Example {
    ...
    private fun run(): Result<Unit, String> {
        ...
        val b = readParseSquareRoot("Enter the second number: ")
                .get { return it }
        return Ok(println("The sum of the square root of the numbers is ${a + b}."))
    }
...
Note that we use `.get { return it }` to handle the error. You can also use `andThen` and `map` function.
            ...
            readParseSquareRoot("Enter the first number: ")
                    .andThen { a ->
                        readParseSquareRoot("Enter the second number: ").map { b ->
                            println("The sum of the square root of the numbers is ${a + b}.")
                        }
                    }
...
* Better syntax for doing `get { return it }`(coroutine?).
* Better cooperation with exception.